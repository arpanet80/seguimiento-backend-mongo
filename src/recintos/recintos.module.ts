...
import { SeguimientoRecinto, SeguimientoRecintoLog, SeguimientoRecintoLogSchema, SeguimientoRecintoSchema } from './entities/seguimiento-recinto.entity';
...
@Module({
  imports: [
    ...
    MongooseModule.forFeature([{ name: SeguimientoRecinto.name, schema: SeguimientoRecintoSchema }]),
    MongooseModule.forFeature([{ name: SeguimientoRecintoLog.name, schema: SeguimientoRecintoLogSchema }]),
